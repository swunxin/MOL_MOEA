classdef MOL_MOEA_v10_bank_time < ALGORITHM
% MOL_MOEA_v10_bank_time: == MOL_MOEA_v10_bank 一字不差(仅类名/文件名不同), 不加任何跟踪。
%   用途: 系统对照实验 —— 跑 200-lead 验证当前环境/流程是否正常出结果。
%   若它也出不来, 则是系统问题, 与 v12 改动无关。
%
