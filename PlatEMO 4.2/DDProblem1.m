...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Setting(obj)
            ...
            if ~isempty(env_comm); commDir = env_comm; else; commDir = fileparts(which(class(obj))); end
        ...
        function PopObj = CalObj(~,~)
            env_comm = getenv('PLATEMO_COMM_DIR');
            if ~isempty(env_comm); commDir = env_comm; else; commDir = fileparts(which('DDProblem1')); end
